    ...
    public class AssetTest : MonoBehaviour
    {
        ...
        public void GetAssetListOriginal()
        {
            ...
            LootLockerSDKManager.GetAssetsOriginal(int.Parse(assetCountToDownload), (response) =>
             ...
             }, valToSend,new List<LootLockerEnums.AssetFilter>() { filter });
        }

        [ContextMenu("Get Asset Original Full")]
        public void GetAssetListOriginalFull()
        {
            int? valToSend = 5711;
            LootLockerSDKManager.GetAssetsOriginal(int.Parse(assetCountToDownload), (response) =>
            {
            ...
            }, valToSend, new List<LootLockerEnums.AssetFilter>() { filter, LootLockerEnums.AssetFilter.nonpopular, LootLockerEnums.AssetFilter.rentable },true,new Dictionary<string, string> { {"Color","red" }, { "Height", "tall" } });
        }
